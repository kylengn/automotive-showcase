  ...
  return (
    <div className="relative h-full">
      ...
      <div className="relative z-10 mt-4 lg:mt-16 px-4 sm:px-6 md:px-8 lg:px-12 max-w-2xl mx-auto lg:mx-0">
        {/* Premium Badge */}
        <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-red-500/10 to-orange-500/10 border border-red-500/30 rounded-full px-3 sm:px-4 py-1.5 sm:py-2 mb-4 sm:mb-6">
          <Award className="h-3 w-3 sm:h-4 sm:w-4 text-red-500" />
          <span className="text-red-600 text-xs sm:text-sm font-medium">LUXURY COLLECTION 2026</span>
        </div>

        {/* Main Heading */}
        <h1 className="font-orbitron font-black text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-slate-800 mb-4 sm:mb-6 leading-tight tracking-tight">
          UNLEASH
          <br />
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3 mb-6 sm:mb-8">
          <div className="flex items-center space-x-1.5 sm:space-x-2 bg-slate-100/80 backdrop-blur-sm rounded-full px-3 sm:px-4 py-1.5 sm:py-2 border border-slate-200/50">
        ...
        {/* Stats */}
        <div className="grid grid-cols-3 gap-4 sm:gap-6 mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-slate-200/50">
          <div>
